...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('hws_contacts', {
      contact_id: {
        allowNull: false,
        autoIncrement: true,
        primaryKey: true,
      ...
      deleted_by: {
        allowNull: true,
        type: Sequelize.INTEGER,
        name: 'hws_contacts_deleted_by_fk',
        references: {
          model: 'hws_org_users',
          key: 'org_user_id'
        },
  ...
  async down(queryInterface, Sequelize) {
    await queryInterface.removeConstraint('hws_contacts', 'hws_contacts_org_id_fk');
    await queryInterface.removeConstraint('hws_contacts', 'hws_contacts_deleted_by_fk');
    await queryInterface.dropTable('hws_contacts');
  }
};